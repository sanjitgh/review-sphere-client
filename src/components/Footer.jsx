...
const Footer = () => {
  return (
    <footer className="pt-20 pb-10  bg-white border-t text-black">
      <div className="container mx-auto px-3">
        <div className="footer">
          <aside>
            <h1 className="logo font-bold md:text-4xl text-2xl">ReviewSphere</h1>
          ...
          <nav>
            ...
            <Link to={"/services"} className="text-base font-normal hover:text-gray-700 transition-all">
              Service
            </Link>
          ...
          <nav>
            ...
            <Link to={"/signup"} className="text-base font-normal hover:text-gray-700 transition-all">
              Sign Up
            </Link>
