...
const OurParters = () => {
  return (
    <div className="md:py-20 py-14 dark:bg-blue-gray-800">
      <div className="max-w-6xl mx-auto px-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-10 place-items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold mb-5 dark:text-gray-200">
              We Work With the <br />
              Best Partners
            </h1>
            ...
            <Button variant="filled" className="flex items-center gap-1 bg-green-600 rounded mt-4 dark:bg-green-800 dark:hover:bg-green-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-20 justify-items-center">
            <div className="text-center mx-auto">
              ...
              <p className="font-semibold mt-3 dark:text-gray-300">
